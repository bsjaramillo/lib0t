...
namespace core
{
    class TCPOutbound
    {
        ...
        public static byte[] Ack(AresClient client)
        {
            ...
            packet.WriteString(client, Settings.Get<String>("roomName","MainSettings"));
        ...
        public static byte[] UserlistBot(AresClient client)
        {
            ...
            packet.WriteUInt16(0);
            packet.WriteByte(0);
            packet.WriteString(client, Settings.Get<String>("botName","MainSettings"));
            packet.WriteIP("0.0.0.0");
            packet.WriteByte(1);
            packet.WriteByte(3);
            packet.WriteByte(0);
        ...
        public static byte[] MyFeatures(AresClient client)
        {
            ...
            if (Settings.Get<bool>("roomScribblesEnabled", "MainSettings"))
                flag |= ServerFeatures.SERVER_SUPPORTS_ROOM_SCRIBBLES;

            packet.WriteByte((byte)flag);
            packet.WriteByte(63);
            packet.WriteByte(Convert.ToByte(Settings.Get<int>("preferredLanguage","AdvancedSettings")));
        ...
        {
            TCPPacketWriter packet = new TCPPacketWriter();
            packet.WriteByte((byte)(Settings.Get<bool>("supportVoiceChat", "MainSettings") ? 1 : 0));
            packet.WriteByte(0);
