...
namespace core
{
    class Events
    {
        ...
        {
            DefaultCommands = Settings.Get<bool>("enableBuiltInCommands","AdminSettings");
        ...
        public static void LoadCustomName(IClient client)
        {
            if (DefaultCommands)
                cmds.LoadCustomName(client != null ? client.IUser : null);
        }
