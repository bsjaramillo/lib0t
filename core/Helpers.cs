...
namespace core
{
    class Helpers
    {
        ...
        private static string[] acols = new string[]
        {
            ...
            Color.Navy.ToHexString(),
            Color.Green.ToHexString(),
            Color.Red.ToHexString(),
            Color.Maroon.ToHexString(),
            Color.Purple.ToHexString(),
            Color.Orange.ToHexString(),
            Color.Yellow.ToHexString(),
            Color.Lime.ToHexString(),
            Color.Teal.ToHexString(),
            Color.Aqua.ToHexString(),
            Color.Blue.ToHexString(),
            Color.Fuchsia.ToHexString(),
            Color.Gray.ToHexString(),
            Color.Silver.ToHexString(),
            Color.OrangeRed.ToHexString(),
            Color.SaddleBrown.ToHexString(),
            Color.DarkCyan.ToHexString(),
            Color.Indigo.ToHexString(),
            Color.Crimson.ToHexString(),
            Color.ForestGreen.ToHexString(),
            Color.DarkOrchid.ToHexString(),
            Color.HotPink.ToHexString(),
            Color.DarkSlateGray.ToHexString(),
            Color.LightSteelBlue.ToHexString(),
            Color.LawnGreen.ToHexString(),
            Color.LightSeaGreen.ToHexString(),
            Color.BurlyWood.ToHexString(),
            Color.Chartreuse.ToHexString(),
            Color.DarkGoldenrod.ToHexString(),
            Color.DarkMagenta.ToHexString(),
            Color.DeepSkyBlue.ToHexString(),
            Color.Gold.ToHexString(),
            Color.LightCoral.ToHexString(),
            Color.MediumPurple.ToHexString(),
            Color.Olive.ToHexString(),
            Color.PaleVioletRed.ToHexString(),
            Color.RosyBrown.ToHexString(),
            Color.SeaGreen.ToHexString(),
            Color.SlateBlue.ToHexString(),
            Color.SpringGreen.ToHexString(),
            Color.Tomato.ToHexString(),
            Color.Violet.ToHexString(),
            Color.Wheat.ToHexString(),
            Color.YellowGreen.ToHexString()
        };
        ...
        {
            if (!Settings.Get<bool>("localClientsAutoLogin","AdvancedSettings"))
                return false;
        ...
        public static bool IsUnacceptableGender(IClient client)
        {
            ...
            {
                case 2:
                    return Settings.Get<bool>("rejectFemale","AdvancedSettings");

                case 1:
                    return Settings.Get<bool>("rejectMale","AdvancedSettings");

                default:
                    return Settings.Get<bool>("rejectUnknown", "AdvancedSettings");
            }
        }

        public static void FormatUsername(IClient client)
        {
            if (client.OrgName == Settings.Get<String>("botName","MainSettings"))
        ...
        {
            if (name == Settings.Get<String>("botName","MainSettings"))
                return false;
        ...
        public static void FakeRejoinSequence(AresClient client, bool features)
        {
            ...
            if (features)
            {
                ...
                client.SendPacket(TCPOutbound.Url(client, Settings.Get<String>("urlLink", "ExtraSettings"), Settings.Get<String>("urlText", "ExtraSettings")));
            }
        ...
        public static void FakeRejoinSequence(ib0t.ib0tClient client, bool features)
        {
            ...
            if (client.Extended)
            {
                ...
                {
                    client.QueuePacket(WebOutbound.UserInfoTo(client, Settings.Get<String>("botName", "MainSettings"), ILevel.Host, Avatars.GotServerAvatar));
                }
                else
                {
