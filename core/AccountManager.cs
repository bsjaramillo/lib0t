...
namespace core
{
    class AccountManager
    {
        ...
        {
            DataPath = Reginux.Sb0tunixPath + "/Dat";
        ...
        public static void SecureLogin(IClient client, byte[] password)
        {
            ...
            {
                String owner = Settings.Get<String>("ownerPassword", "AdminSettings");
                ...
                var linq = Settings.Get<bool>("checkPasswordsAgainstClients","AdminSettings") ?
        ...
        public static void Login(IClient client, String password)
        {
            ...
            using (SHA1 sha1 = SHA1.Create())
            {
                ...
                Account a = Settings.Get<bool>("checkPasswordsAgainstClients","AdminSettings") ?
