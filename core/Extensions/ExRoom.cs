    ...
    class ExRoom : IRoom
    {
        ...
        public byte MinimumAge
        {
            get
            {
                ...
                return (byte)Settings.Get<int>("minimumAge", "AdvancedSettings");
            }
        }

        public bool CustomNamesEnabled
        {
            get { return Settings.Get<bool>("canCustomnames","ExtraSettings"); }
            set { Settings.Set("canCustomnames", "ExtraSettings", value); }
        }

        public String BotName
        {
            get { return Settings.Get<String>("botName","MainSettings"); }
        }

        public void ClearURL()
        {
            Settings.Set("urlText", "ExtraSettings", String.Empty);
            Settings.Set("urlLink", "ExtraSettings", String.Empty);
        ...
        {
            Settings.Set("urlText", "ExtraSettings", text);
            Settings.Set("urlLink", "ExtraSettings", address);
